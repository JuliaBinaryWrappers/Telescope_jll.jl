# Autogenerated wrapper script for Telescope_jll for x86_64-apple-darwin
...
JLLWrappers.@declare_library_product(libtelescope, "@rpath/libtelescope.dylib")
